...
namespace Nox.Relay.Runtime.Voice {
	/// <summary>
	/// RMS jitter calculator — MetaVoiceChat VcJitter equivalent.
	/// Tracks network jitter to dynamically adjust output latency.
	/// </summary>
	public class NoxVoiceJitter {
		...
		public NoxVoiceJitter(NoxVoiceConfig config) {
